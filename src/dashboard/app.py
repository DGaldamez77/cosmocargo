...
def view_shipment(id):
    if request.method == 'GET':
        ...
        ref_data = {
            "shipment_status": get_ref_data("shipment_status"),
            "precipitation_kinds": get_ref_data("precipitation_kind"),
            "solar_systems": get_ref_data("solar_system"),
            "planets": get_ref_data("planet"),
            "countries": get_ref_data("country"),
        }
        ...
        update_shipment(id, request.form)
